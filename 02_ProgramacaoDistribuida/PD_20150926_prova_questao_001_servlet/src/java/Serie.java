...
public class Serie extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            Integer intNumero = new Integer(strNumero);
            String saida = "";
            ...
            out.println("<h5>Você digitou: "+strNumero+"</h5>");
            
            for (int i = 0; i < intNumero.intValue(); i++)
                saida += Integer.toString(i)+",";
            out.println(saida.substring(0, saida.length()-1));
            out.println("</body>");
            out.println("</html>");
        }
    }
